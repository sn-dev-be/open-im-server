...
func (c *ClubRpcClient) GetServerGroups(ctx context.Context, serverIDs []string) (*club.GetGroupsByServerResp, error) {
	resp, err := c.Client.GetGroupsByServer(ctx, &club.GetGroupsByServerReq{
		ServerIDs: serverIDs,
	})
	if err != nil {
		return nil, err
