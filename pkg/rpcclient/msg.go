...
func newContentTypeConf() map[int32]config.NotificationConf {
	return map[int32]config.NotificationConf{
		...
		constant.SignalingSingleChatErrorClosedNotification: {IsSendMsg: true, ReliabilityLevel: constant.UnreliableNotification},
		...
		constant.ServerGroupDismissNotification:        config.Config.Notification.ServerGroupDismiss,
